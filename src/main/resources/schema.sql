...
alter table person_project add constraint project_id_valid foreign key (project_id) references project;
alter table person_project add constraint person_id_valid foreign key (person_id) references person;
